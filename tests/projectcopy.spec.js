...
test("Verify that a Video can be recommended", async ({ page }) => {
  ...
  await page
    .getByPlaceholder(
      "Share any video/article, which benefits your organization!"
    )
    .fill("https://www.youtube.com/watch?v=Pm2BvdiZUXA", { delay: 100 });
  await page.keyboard.press("Enter");
  await page.getByPlaceholder("Min").fill("14");
  await page
    .locator("#popup")
    .getByRole("button", { name: "Recommend" })
    .click();
...
test("verify that an article can be recommended", async ({ page }) => {
  ...
  await page
    ...
    .fill("https://playwright.dev/docs/actionability");
  await page.keyboard.press("Enter");
  ...
  await page
    ...
    .getByRole("button", { name: "Recommend" })
    .dblclick();
  await expect(page.locator(".tippy").nth(0)).toHaveText(
...
test("verify same link cannot be recommended again", async ({ page }) => {
  ...
  await page
    ...
    .fill(
      "https://stackoverflow.com/questions/74980624/can-i-use-textsplit-with-find-formula"
    );
  await page.keyboard.press("Enter");
  await page.getByPlaceholder("Min").fill("10");
  await page
  ...
  await expect(page.locator(".duplicate-message")).toHaveText(
    "Oops! We have predicted a similar recommendation View"
  );
});
...
test("verify on selecting video type content filter only recommended video is displayed on home page", async ({
  page,
}) => {
  await page.locator(".filter-dropdown").click();
  ...
  for (let i = 0; i < 20; i++) {
    await expect(
      page.locator("span[class='challenge-type video']").nth(i)
    ).toBeVisible();
  }
});
test("verify on selecting audio content filter only recommended audio files are displayed", async ({
  page,
}) => {
  await page.locator(".filter-dropdown").click();
  ...
  for (let i = 0; i < 15; i++) {
    await expect(
      page.locator("span[class='challenge-type audio']").nth(i)
    ).toBeVisible();
  }
});
test("verify on selecting book content filter only recommended books are displayed", async ({
  page,
}) => {
  await page.locator(".filter-dropdown").click();
  ...
  for (let i = 0; i < 3; i++) {
    await expect(
      page.locator("span[class='challenge-type book']").nth(i)
    ).toBeVisible();
  }
});
test("verify on selecting article filter only recommend articles are displayed", async ({
  page,
}) => {
  await page.locator(".filter-dropdown").click();
  ...
  for (let i = 0; i < 15; i++) {
    await expect(
      page.locator("span[class='challenge-type article']").nth(i)
    ).toBeVisible();
  }
});
test("verify on clicking edit from more options of link outercard edit popup should populate", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that link edited to no title cannot be saved", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that the link edited to only special characters in title cannot be saved", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that only 5 tags can be added at max in a link", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that a user cannot add duplicate tags", async ({ page }) => {
  ...
  await expect(page.locator(".warning")).toContainText(
    "Already the tag has been added!"
  );
});
test("verify that a tag can contain max 25 characters", async ({ page }) => {
  ...
  await page.locator(".more-settings").click();
  await page
    .getByPlaceholder("Add tag")
    .type("123456789009876543211234567890", { timeout: 5000 });
  await page.keyboard.press("Enter");
  await expect(page.locator(".warning")).toContainText(
    "Please enter tag with character length less than or equal to 25!"
  );
});
...
test("Verify only one content type can be choosen", async ({ page }) => {
  ...
  const RadioButton = await page.locator("#video .radio-button").isChecked;
...
test("verify that link cannot be edited 0/null minutes minutes", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that link cannot be edited to minutes in special characters", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that link cannot be edited to minutes in alphabets", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that the max minutes a link can have is 10000", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that on clicking pay it forward the popup box opens", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that pay it forward popup contaians embed link image", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
  await page.locator("[data-status='pay-forward']").nth(0).click();
  await expect(
    page.locator("a").filter({ hasText: "10m" }).first()
  ).toBeVisible();
});

test("verify that a person can be selected only once in payit forward", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify that notes can be added while paying forward a link", async ({
  ...
  await page
    ...
    .click();
  await page
    .getByPlaceholder("Type your note here....")
    .fill("test note", { delay: 100 });
  await page.getByRole("button", { name: "Share" }).click();
  await page.locator("div .success").waitFor();

  await expect(page.locator("div .success")).toContainText("Shared");
});
test("verify that on clicking the delete from more options delete popup is opened", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify on clicking cancel button of the delete popup the popup goes away", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
test("verify on clicking no on the delete popup, popup closes", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).hover();
  await page.locator(".link-dropdown").nth(0).click();
...
//******************LINK INNERVIEW***************************
test("verify on clicking the link outercard the link innerview of the same link is opened", async ({
  page,
}) => {
...
test("verify that the recommendor's name is  visible in the link innerview", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
...
test("verify that name of the university is visible in the link innerview", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await expect(page.locator("div a#anywhereworks")).toContainText(
    "AnywhereWorks"
  );
});
test("Verify that recommendation date is present on link innerview", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
...
test("verify that learning minutes of the link is visible in the link innerview", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await expect(page.locator(".link-min")).toBeVisible();
});
test("verify that more options in link innerview is clickable", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
...
test("Verify that if the link is added to learn the add to learn checkbox is checked", async ({
  page,
}) => {
  await page
    .locator("figcaption", {
      has: page.locator("[data-tippy-content='Added to Learn']").nth(0),
    })
    .click();
  await expect(page.locator(".add-myq.active")).toBeVisible();
});

test("verify on clicking the edit option edit popup is visible", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify on giving null minutes from edit the link is not saved", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify that min field is not accepting special characters as input", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify that min field is not accepting 0/null value", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify taht min field is not accepting only alphabets ", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify that on updating the minutes, the same is reflected in the link innerview", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify if the link title is edited, the updated title is reflected in the linkinnerview", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify that the title should not contain only special characters", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
  ...
  await page.getByRole("button", { name: "save" }).click();
  await expect(page.locator(".warning")).toContainText(
    "Please provide link name with at least one character other than special characters!"
  );
});
// only numbers is left, would write after recommend link feature is fixed

test("verify that the link should not have an empty title", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify that a link title should not accept more than 200 characters", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify if the link field is empty  it should not be saved", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify if the link field contains only alphabets it should not be saved", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify if the link field contains only numbers it should not be saved", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify if the link field contains only special charcters should not be saved", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify if invalid link is added an error message is thrown", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
  ...
  await page
    ...
    .fill("https://www.youtube.cooom/watch?v=RHbBEFk7kHQ");
  await page.getByRole("button", { name: "save" }).click();
  await expect(page.locator(".warning")).toContainText(
    "Please provide valid link!"
  );
});
test("verify that link can be paid forwrded from more options", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify that a link cannot be paid forwarded without recepients", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
  await page.locator(".pay-forward").click();
  await expect(
    page.locator(".share-button", { has: page.locator(".btn-cta") })
  ).toBeDisabled();
});
test("verify that a user cannot choose oneself while paying forward a link", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
  await page.locator(".pay-forward").click();
  await page
    .getByPlaceholder("Type to add people")
    .type("shakti aryan", { delay: 100 });
  await expect(page.locator("button.btn-cta").nth(1)).toBeDisabled();
});
test("verify that on giving just two characters search dropdown should not open", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".dropdown-select").click();
...
test("verify that a user cannot give an empty takeaway", async ({ page }) => {
  ...
  await expect(page.locator(".warning")).toContainText(
    "Complete the takeaway step"
  );
});

test("verify the takeaway text area has user's profile pic", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
...
test("verify on giving a takeaway (apart from video link) the progress percentage goes to 45%", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
...
test("verify on clicking remove progress the progress is removed", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".ql-editor").fill("test");
...
test("verify on clicking no on the remove progress popup, popup goes away", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".ql-editor").fill("test");
...
test("verify on clicking cancel on remove progress popup,popup goes away", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".ql-editor").fill("test");
...
test("verify that the progress bar is reflected in the link outercard ", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".ql-editor").fill("test");
...
test("verify that on completing the takeaway step learning minutes are accumulated ", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".ql-editor").fill("test");
...
test("verify that the takeaways can be edited", async ({ page }) => {
  ...
  await expect(page.locator(".ql-editor")).toContainText(
    "testing sample takeaway"
  );
});
test("verify that the edited takeaway has edited visible in the takeaway text area", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  /*await page.locator(".ql-editor").fill("test");
  ...
  await page.getByRole("button", { name: "Save" }).click();
  await expect(
    page.getByRole("main").getByRole("listitem").getByText("13 Feb (edited)")
  ).toBeVisible();
});
test("verify that the given takeaway cannot be edited to null takeaway", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".review-edit").click();
  ...
  await page.getByRole("button", { name: "Save" }).click();
  await expect(page.locator(".warning")).toContainText(
    "Takeaway step cannot be empty"
  );
});
test("verify on clicking cancel after giving edited takeaway, the previous takeaway remains entact", async ({
  page,
}) => {
  await page.locator(".challenge-image").nth(0).click();
  await page.locator(".review-edit").click();
...
test("verify when italics option is clicked the takeaway text turn italics", async ({
  ...
  await expect(page.locator("p em")).toBeVisible();
});
test("verify when underlined is clicked the takeaway text is underlined", async ({
  ...
  await expect(page.locator("div p u")).toBeVisible();
});
...
test("verify whether the text can be italics and underlined", async ({
  ...
  await page.locator(".ql-italic").click();
  await page.locator(".ql-underline").click();
  await expect(page.locator("p em u")).toBeVisible();
});
test("verify that a text can be bold italics and underlined", async ({
  ...
  await page.locator(".ql-italic").click();
  await page.locator(".ql-underline").click();
  await expect(page.locator("p strong em u")).toBeVisible();
});
test("verify that a text can be consolidated in numbered points", async ({
  ...
  await page.locator(".ql-list").nth(0).click();

  await expect(page.locator("div ol li")).toBeVisible();
});
test("verify that a takeaway can be consolidated into bullet points", async ({page}) => {
  ...
  await page.locator(".ql-list").nth(1).click();

  await expect(page.locator("[value='bullet']")).toHaveClass("ql-list ql-active")
});
